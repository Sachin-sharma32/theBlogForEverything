...
const TopPosts = () => {
    ...
    return (
        <div className=" mt-10 flex justify-center flex-col p-2 md:p-10 md:gap-4 relative">
            <h2 className="bg-gradient-to-r from-[#eb9586] to-blue-500 bg-clip-text text-transparent text-xl font-bold text-center md:hidden">
                TOP POSTS OF THE WEEK
            </h2>
            <section className="flex overflow-x-scroll p-2 gap-4 h-96 items-center">
                <section className=" flex-col justify-end bg-gradient-to-b from-[#eb9586] to-blue-500 p-10 rounded-md text-white min-w-[200px] md:min-w-[300px] h-80 hidden md:flex">
