    ...
    return (
        <Layout>
            ...
            <Head>
                ...
                <meta property="og:title" content={`TBFE Blogs - ${search}`} />
                <meta
                ...
                <meta
                    property="og:url"
                    content={`https://theblogforeverything.com/search/blogs/${search}`}
                />
            ...
            >
                <Posts
                    values={{
                        title: `SHOWING BLOGS FOR ${search}`,
                        filter: search,
                        type: "blog",
                    }}
                />
