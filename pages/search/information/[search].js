...
const Search = () => {
    ...
    posts = posts.filter((post) => post.type === "information");
    console.log(posts);
    ...
    return (
        <>
            <div
                className={` flex gap-1 sm:gap-2 px-2 sm:px-1 text-xs fixed top-[48px] w-full sm:pt-2 h-fit z-40 pb-2 ${
                ...
                <div>
                    {filterPosts.length > 0 ? (
                        ...
                        >
                            ...
                            >
                                <span>NO INFORMATION FOUND FOR</span>
