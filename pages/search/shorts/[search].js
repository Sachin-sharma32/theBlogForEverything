    ...
    return (
        <Layout>
            ...
            <Head>
                ...
                <meta property="og:title" content={`TBFE Shorts - ${search}`} />
                <meta
                ...
                <meta
                    property="og:url"
                    content={`https://theblogforeverything.com/search/shorts/${search}`}
                />
            ...
            >
                <Posts
                    values={{
                        title: `SHOWING SHORTS FOR ${search}`,
                        filter: search,
                        type: "short",
                    }}
                />
